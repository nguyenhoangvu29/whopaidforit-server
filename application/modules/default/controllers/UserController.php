...
class UserController extends Zend_Controller_Action {
	 ...
	 */
	public function getuserinfoAction() {				$user_id = $this->_request->getParam ( 'id' );
		...
		foreach ( $rows as $row ) {
			...
			$result ['properties'] [] = array (
					...
					'last_name' => $row->last_name,					'password' => $row->password,
	...
	public function getmemberbyeventAction() {
		...
		$table = new Default_Model_User (); // user_pieces là class extends
	...
	function loginAction() {
		...
		$model_event = new Default_Model_Event ();
